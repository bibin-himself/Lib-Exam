...
DSPACE 2002 KOHA 2000
NEWGENLIB 2007 EPRINTS 2000



> Programming Languages
FORTRAN 1957 JAVA 1994
VB 1991 C 1972
C++ 1983 JAVA SCRIPT 1995
PHP 1995
...
INIS:
 The INIS Database, contains over 3 million bibliographic records
...
>SANJAY and TRISHNA (often spelled Thrishna):
 - Library automation software packages developed in India during the 1990s.
 - They were built by augmenting UNESCO's CDS/ISIS (V2.3) 
 - Meets the local script and functional housekeeping demands of Indian libraries.
 - Both Catalyzed and sponsored by NISSAT (National Information System for Science and Technology)

 >SANJAY
  Developed by a team of software professionals at DESIDOC.
  SANJAY modified CDS/ISIS into a complete Integrated Library Management Software (ILMS) package
...
, (Comma)
    Personality The most specific or core characteristic of a subject Persons, organs, entities, specific diseases

; (Semicolon)
    Matter The physical material or substance composing a subjectWood, steel, chemicals, tissue

: (Colon)
    Energy Action, process, or operation performed on or by a subjectTreatment, research, management, cooking

. (Dot)
    Space The geographic or spatial location of a subjectCountries (e.g., India), continents, cities

' (Single Inverted Comma)
    Time The period or date associated with a subjectYears (e.g., 1950), centuries, decades





Taylor Model	Robert S. Taylor	4 levels of info need
Krikelas Model	James Krikelas	   Need arises from uncertainty
Wilson Model	T. D. Wilson	   Influence of enviro factors
Dervin Model	Brenda Dervin	   Gap-bridging approach
...
>>>>> DESIDOC <<<<<
 Defence Scientific Information & Documentation Centre
   ...
   Headquarters	       :  New Delhi
   Famous LIS Journal	 :  DESIDOC Journal of Library & Information Technology: (DJLIT)
   Maintains	          :  Defence Science Library (DSL)
   Major Services	       :  CAS, SDI, Translation, Reference, Document Delivery
...
Established	               1970
Parent Organization	      ICSSR
Headquarters	            New Delhi
Subject Coverage	         Social Sciences
Maintains	               Social science DBss and docu services
Target Users	      Social science researchers and institutions
...
Parent Institution	NI for MSME
Ministry	            Ministry of MSME
Library Software	   LIMS
Famous Journal	      SEDME
Major Users	         MSMEs, Entrepreneurs, Researchers



>>>>> AGRIS <<<<<  -----> Module 6 line 553
 1974 operational 1975
 FAO's international agricultural information system,
 Modelled on INIS and 
 Coordinated through the AGRIS/CARIS Centre at Rome.

 Provides agricultural literature through the AGRIS Database, AGRINDEX, SDI, retrospective searching, national and subject bibliographies,
 Uses AGROVOC for indexing, 

 India is represented by ICAR's Agricultural Research Information Centre (ARIC).



>>>>> INIS <<<<<  -----> Module 6 line 606
 INIS (1970)
  IAEA-sponsored international nuclear information system headquartered in Vienna.

  Decentralized, computer-based, mission-oriented network  Provides Atomindex, Document Delivery Service, CAS, SDI, Retrospective Search, Online Retrieval, and INIS Thesaurus-based indexing

  India's participation coordinated through BARC, Mumbai.
...
>>>>> MEDLARS <<<<<  -----> Module 6 line 658
  Medical Literature Analysis and Retrieval System
  1964
  By the National Library of Medicine (USA)
  World's first large-scale computerized biomedical information retrieval system.

  It used MeSH for subject indexing,
  Produced Index Medicus, offered CAS, SDI, literature searches, and bibliographic services,

  Evolved into MEDLINE (1971) and PubMed (1997).




>>>>> OCLC <<<<<  -----> Module 6 line 716
  OCLC (1967)
  Founded by Frederick G. Kilgour
